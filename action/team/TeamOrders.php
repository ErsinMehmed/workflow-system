...
?>
    <div class="w-full sm:w-[230px] h-[132px] rounded-md shadow-lg p-3 border border-slate-100 text-slate-700 space-y-1.5">
        <span class="text-xl font-bold">Заявка номер <?= $rows["id"] ?></span>
        <div class="flex items-center">
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-500 mr-1.5">
        ...
        <div class="flex items-center">
            ...
            <span class="text-sm text-slate-500"><?= $rows["date"] ?></span>
        </div>
        <div class="flex items-center">
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-500 mr-1.5">
