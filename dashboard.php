            ...
            <div id="main-section" :class="toggleSidebar ? 'ml-14 lg:ml-64' : 'ml-0'" class="h-screen w-full bg-gray-100 relative overflow-y-auto">
              ...
              <section v-show="dashProfile">
                <div class="py-6 px-8 w-full">
                  <div class="md:flex w-full items-center gap-x-5 space-y-4 md:space-y-0">
                    <div class="w-full md:w-1/2 rounded-md shadow-xl border border-slate-100 bg-white p-4">
                      ...
                      <div class="flex flex-wrap items-center gap-x-3.5 gap-y-3 mt-1.5">
                        <?php if ($roles["full_role"] == 1) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Четене</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Добавяне</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Редактиране</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Изтриване</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Назначаване</div>
                        <?php } else if ($roles["edit_role"] == 1) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Четене</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Редактиране</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Изтриване</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Назначаване</div>
                        <?php } else if ($roles["create_role"] == 1) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Четене</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Добавяне</div>
                        <?php } else { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Четене</div>
                      ...
                      <div class="flex flex-wrap items-center gap-x-3.5 gap-y-3 mt-1.5">
                        <?php if ($roles["nomenclature_view"] == 0 && $roles["personal_view"] == 0) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Всички</div>
                        <?php } else if ($roles["personal_view"] == 0) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Заявки</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Персонал</div>
                        <?php } else if ($roles["nomenclature_view"] == 0) { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Заявки</div>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Номенклатури</div>
                        <?php } else { ?>
                          <div class="shadow-lg bg-white py-1 px-2 rounded-xl border border-slate-100 text-slate-700 font-semibold">Заявки</div>
                        <?php } ?>
                      </div>
                    </div>
                    <form id="admin-information-form" class="w-full md:w-1/2 rounded-md shadow-xl border border-slate-100 bg-white px-4 py-5">
                      <div class="w-full">
