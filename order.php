        ...
        <form id="guest-order-form">
          <div class="w-full p-6 md:p-8 text-slate-700">
            ...
            <div class="my-4 sm:flex items-center sm:space-x-5 space-y-4 sm:space-y-0">
              <div class="sm:w-1/2">
                <input type="date" min="<?php echo date("Y-m-d", strtotime('+1 day', time())); ?>" value="<?php echo date("Y-m-d", strtotime('+1 day', time())); ?>" name="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full p-2.5" placeholder="Изберете дата" />
              </div>
