      ...
      <div class="w-full py-10 md:py-14 lg:py-20 xl:py-24 2xl:py-32 md:flex items-center">
        ...
        <div class="w-full md:w-1/2 text-slate-700 px-10 md:px-0 md:pr-6 lg:pr-24" data-aos="slide-left" data-aos-duration="2000">
          ...
          <div class="w-full flex items-center mt-3.5 sm:mt-4 md:mt-5 sm:pl-10 md:pl-0">
            <button data-modal-toggle="call-us-modal" class="px-6 py-1.5 lg:px-8 lg:py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg lg:text-lg xl:text-xl transition-all active:scale-90">
              Поръчка
            </button>
            ...
            <div class="p-7 sm:space-x-8 pr-9 sm:flex items-center">
              ...
              <div class="w-full mt-2.5 sm:mt-0">
                ...
                <div class="relative my-4">
                  ...
                  <input type="text" name="" class="bg-white border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-0 focus:outline-none focus:border-gray-400 block w-full pl-10 p-2.5" placeholder="Вашите имена" />
                </div>
                <div class="relative my-4">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
        ...
        <div>
          ...
          <ul>
            ...
            <li class="mb-3 flex items-center">
              ...
              <span>carpetserv@gmail.com</span>
            </li>
            <li class="mb-3 flex items-center">
              <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3.5 h-3.5 mr-1">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
              </svg>
              <span>+359 899 845 743</span>
            </li>
          </ul>
        </div>
        <div>
