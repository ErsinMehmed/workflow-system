                  ...
                  <div class="bg-[#222e3c]">
                    ...
                    <ul class="pb-2 text-gray-400">
                      ...
                      <li @click="dashOrder = true; dashUser = false; dashTeam = false; dashWarehouse = false; dashSupplier = false; dashClient = false; productOrder = false; dashProfile = false; dashSchedule = false; dashSection = 'Заявки'" :class="dashOrder ? 'text-white border-l-4 border-[#3b7ddd] bg-gradient-to-r from-[#3a4b5e] via-[#2f3c4b] to-[#2f3c4b] bg-opacity-50' : 'hover:text-gray-300'" class="text-base w-full flex items-center py-2.5 px-4 transition-all cursor-pointer mb-1">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-[18px] h-[18px]">
          ...
          <Transition name="fade">
            <div id="main-section" :class="toggleSidebar ? 'ml-14 lg:ml-64' : 'ml-0'" class="h-screen w-full bg-gray-100 relative overflow-y-auto">
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-48">
                      ...
                      <input type="text" id="search-order" placeholder="По номер или име" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5" />
                    </div>
                    <div class="relative w-full sm:w-48">
                      <div id="date-prev" class="absolute inset-y-0 left-0 flex items-center px-0.5 cursor-pointer hover:bg-slate-100 transition-all text-gray-500 hover:text-slate-800 bg-slate-50 rounded-l-lg border border-r-0 border-gray-300">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2.4" stroke="currentColor" class="w-5 h-5">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                        </svg>
                      </div>
                      <input id="order-filter-date" type="date" value="<?php echo date("Y-m-d"); ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none block w-full px-7 p-2.5" placeholder="Изберете дата" />
                      <div id="date-next" class="absolute inset-y-0 right-0 flex items-center px-0.5 cursor-pointer hover:bg-slate-100 transition-all text-gray-500 hover:text-slate-800 bg-slate-50 rounded-r-lg border border-l-0 border-gray-300">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2.4" stroke="currentColor" class="w-5 h-5">
                              ...
                              <tr class="bg-white hover:bg-slate-50 transition-all border-b border-gray-200 text-sm">
                                ...
                                <td class="px-4 py-5 flex items-center justify-center text-center space-x-2">
                                  <?php if ($roles["edit_role"] == 1 || $roles["full_role"] == 1) {
                                    ...
                                    <?php
                                    if ($rows["status"] == "Приключена" && $rows["invoice_document"] == "" && $rows["invoice"] == "Да") { ?>
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-48">
                      ...
                      <input type="text" id="search-user" placeholder="По име или пид" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5" />
                    </div>
                    <div class="relative w-full sm:w-48">
                      <select id="select-position" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 cursor-pointer">
                    ...
                    <div class="relative w-full sm:w-48">
                      <select id="select-status" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 cursor-pointer">
                      ...
                      <table id="user-table" class="min-w-full leading-normal bg-white">
                        <thead>
                          <tr class="border-b-2 border-gray-200 bg-gray-100 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">
                            ...
                            <th class="px-4 py-3 cursor-pointer user_column_sort" id="user-name-sort" name="name" data-order="desc">
                              <div class="flex items-center justify-center">
                                <div>име</div>
                            ...
                            <th class="px-4 py-3 cursor-pointer user_column_sort" id="user-pid-sort" name="pid" data-order="desc">
                              <div class="flex items-center justify-center">
                                <div>пид</div>
                            ...
                            <th class="px-4 py-3 cursor-pointer user_column_sort" id="user-team-sort" name="team_name" data-order="desc">
                              <div class="flex items-center justify-center">
                                <div>екип</div>
                            ...
                            <th class="px-4 py-3 cursor-pointer user_column_sort" id="user-in-date-sort" name="in_date" data-order="desc">
                              <div class="flex items-center justify-center">
                                <div>назначен</div>
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="9">
                              <div class="flex justify-between py-2.5 px-5 w-full">
                                ...
                                <ul class="inline-flex items-center -space-x-px">
                                  ...
                                  $query_run = mysqli_query($con, $query);
                                  $totealUser = ceil(mysqli_num_rows($query_run) / 10);
                              ...
                              <input id="user-table-pagination" type="hidden" value="0" />
                            </td>
                          </tr>
                        </tfoot>
                      </table>
                          ...
                          <div class="px-5 py-4 space-y-6 text-slate-700">
                            <div class="sm:flex items-center w-full space-y-4 sm:space-y-0 sm:space-x-5 xl:space-x-6">
                              <div class="w-full">
                                ...
                                <label for="user-hourly-rate" class="block ml-1 mb-1 text-sm font-semibold text-slate-700">Ставка на час</label>
                                <select id="user-hourly-rate" name="hourlyRate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 mb-4">
                          ...
                          <div class="px-5 py-4 space-y-6 text-slate-700">
                            <div class="sm:flex items-center w-full space-y-4 sm:space-y-0 sm:space-x-5 xl:space-x-6">
                              <div class="w-full">
                                ...
                                <label for="user-hourly-rate-edit" class="block ml-1 mb-1 text-sm font-semibold text-slate-700">Ставка на час</label>
                                <select id="user-hourly-rate-edit" name="hourlyRate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 mb-4">
                                  <option value="5.50">5.50</option>
                                  <option value="6.00">6.00</option>
                                  <option value="6.50">6.50</option>
                                  <option value="7.00">7.00</option>
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-48">
                      ...
                      <input type="text" id="search-team" placeholder="По номер или име" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5" />
                    </div>
                    <div class="flex items-center space-x-3">
                      <?php if ($roles["create_role"] == 1 || $roles["full_role"] == 1) { ?>
              ...
              <section class="animate__animated animate__fadeIn animate__faster" v-show="dashSchedule">
                <div class="py-6 px-8 flex w-full">
                  <div class="w-[65%] 2xl:w-[90%] h-fit pt-5 shadow-lg rounded-t-md border border-slate-50 bg-white">
                    <div class="mt-0.5 pb-3.5 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3 pr-4 border-b border-slate-200">
                      <div class="relative w-full sm:w-48">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-2.5 pointer-events-none">
                          <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                        ...
                        <input type="text" id="search-user-schedule" placeholder="По име или пид" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5" />
                      </div>
                      <div class="relative w-full sm:w-48">
                        <select id="select-position-user" class=" bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 cursor-pointer">
                          <option value="Всички">Всички</option>
                          <option value="Хигиенист">Хигиенист</option>
                          <option value="Шофьор">Шофьор</option>
                        </select>
                    ...
                    <input type="hidden" id="get-user-name-schedule">
                  </div>

                  <div class="w-[35%] 2xl:w-[30%] h-fit pl-6">
                    <div class="rounded-md shadow-lg bg-white">
                      <div class="flex items-center justify-start pt-6 px-6">
                        <span class="text-lg font-semibold text-slate-700 focus:outline-none"><span id="show-date"></span></span>
                      </div>
                      <div class="px-5 mt-3">
                        <table class="w-full">
                          <thead>
                      ...
                      <div class="flex items-center gap-x-4 px-5 mt-3.5 text-white text-sm font-semibold">
                        <button id="clear-user-work-schedule" type="button" class="w-full bg-red-500 hover:bg-red-600 rounded-md px-5 py-2 focus:outline-none transition-all active:scale-95">Изчисти</button>
                        <button id="select-user-work-schedule" type="button" class="w-full bg-emerald-500 hover:bg-emerald-600 rounded-md px-5 py-2 focus:outline-none transition-all active:scale-95">Избери</button>
                        <button id="add-user-work-schedule" type="button" class="w-full bg-blue-500 hover:bg-blue-600 rounded-md px-5 py-2 focus:outline-none transition-all active:scale-95">Запази</button>
                      </div>
                      <div class="relative overflow-hidden px-8 bg-gray-50 mt-6 rounded-b-md space-y-5">
                        <div id="user-question">
                          ...
                          while ($rows = mysqli_fetch_array($execute)) {
                            ...
                            $query = "SELECT * FROM user_questions WHERE user_pid = '$pid' AND admin_approval IS NULL";
                            $queryRun = mysqli_query($con, $query);

                            while ($row = mysqli_fetch_array($queryRun)) { ?>
                              <div class="slide-message-container">
                                <div class="slide-message border-b py-3.5 border-slate-300 border-dashed">
                                  <div class="inner-message cursor-pointer active:cursor-grabbing active:opacity-50 select-none text-slate-700">
                                    <div class="text-xs leading-3 tracking-wide"><?= date("H:i - d.m.Y", strtotime($row["add_date"])) ?></div>
                                    <div class="focus:outline-none font-semibold leading-5 mt-1"><?= $rows["name"] ?></div>
                                    <div class="text-sm"><?= $row["question"] ?></div>
                                  </div>
                                  <div class="hidden accept-message bg-green-50 rounded-md w-gull py-4">
                                    <div class="bg-[#4ade80] w-7 h-7 rounded-full shadow-md mx-auto flex items-center justify-center">
                                      <svg fill="none" viewBox="0 0 24 24" stroke-width="3.2" stroke="currentColor" class="w-4 h-4 text-white">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                      </svg>
                                    </div>
                                    <div class="text-green-500 font-semibold text-center">Съобщението е изпратено успешно</div>
                                  </div>
                                  <div class="hidden reject-message bg-red-50 rounded-md w-gull py-4">
                                    <div class="bg-[#f87171] w-7 h-7 rounded-full shadow-md mx-auto flex items-center justify-center">
                                      <svg fill="none" viewBox="0 0 24 24" stroke-width="3.2" stroke="currentColor" class="w-4 h-4 text-white">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                      </svg>
                                    </div>
                                    <div class="text-red-500 font-semibold text-center">Съобщението е отхвърлено успешно</div>
                                  </div>
                                  <input type="hidden" id="id-question" value="<?= $row["id"] ?>" />
                                </div>
                              </div>
                          <?php }
                          } ?>
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-auto">
                      ...
                      <input type="text" id="search-product" placeholder="По номер или име" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5 sm:w-48" />
                    </div>
                    <div class="relative w-full sm:w-48">
                      <select id="select-product-kind" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 cursor-pointer">
                        <option value="Всички">Всички</option>
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-auto">
                      ...
                      <input type="text" id="search-order-product" placeholder="По име или доставчик" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5 sm:w-48" />
                    </div>
                    <div class="relative w-full sm:w-48">
                      <select id="select-order-product-kind" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-400 block w-full p-2.5 cursor-pointer">
                        <option value="Всички">Всички</option>
                        <option value="Препарати">Препарати</option>
                        <option value="Техника">Техника</option>
                        <option value="Екипировка">Екипировка</option>
                ...
                <div class="py-6 px-8">
                  <div class="my-2 w-full sm:flex items-center justify-end space-y-4 sm:space-y-0 sm:space-x-3">
                    <div class="relative w-full sm:w-auto">
                      ...
                      <input type="text" id="search-supplier" placeholder="По име" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-400 focus:outline-none block w-full pl-9 p-2.5 sm:w-48" />
                    </div>
                    <div class="flex items-center space-x-3">
                      <?php if ($roles["create_role"] == 1 || $roles["full_role"] == 1) { ?>
          ...
          <div class="w-[30rem] relative h-auto">
            <form id="dashboard-login-form" class="mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl text-slate-700">
              ...
              <div>
                ...
                <div class="relative mt-1">
                  <input :type="showHideAdminPass ? 'password' : 'text'" id="password" name="password" class="w-full rounded-lg border border-slate-50 p-2.5 pr-12 text-sm shadow-sm focus:border-slate-100 focus:outline-none" placeholder="Въведи парола" />
                  <span @click="showHideAdminPass = !showHideAdminPass" class="absolute inset-y-0 right-4 inline-flex items-center active:scale-90 transition-all cursor-pointer">
                    <svg v-show="showHideAdminPass" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    </svg>
                    <svg v-show="!showHideAdminPass" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
